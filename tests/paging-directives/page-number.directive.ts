...
import { ListDirective, PagedPagerComponent, PageNumberDirective, RTList } from "../../index";
...
describe("rtPageNumber directive", () => {
    ...
    beforeEach(() => {
        ...
        pageNumberDirective = fixture.debugElement
            .query(By.directive(PageNumberDirective))
            .injector.get(PageNumberDirective);
    });
