import { BufferedPagerComponent, ListDirective, RowCountDirective, RTList } from "../../index";
...
describe("rtRowCount directive", () => {
    ...
    beforeEach(() => {
        ...
        pagerComponent = fixture.debugElement.query(By.css("rt-buffered-pager"))
            .componentInstance as BufferedPagerComponent;
