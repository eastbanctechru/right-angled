...
import {E2E4SelectableItemAttribute} from '../e2e4-angular/e2e4SelectableItemAttribute';

@Component({
    directives: [E2E4List, E2E4LoadButton, E2E4RowNumber, E2E4Sort, E2E4SelectionArea, E2E4SelectableItemAttribute],
