...
import { RtNullObjectInjectable } from './list-directives/null-object-injectable';
...
export var PAGED_LIST_PROVIDERS: any[] = [
    AsyncSubscriber,
    RtListService,
    provide(BufferedPager, { useValue: RtNullObjectInjectable.instance }),
    provide(RegularPager, { useValue: RtNullObjectInjectable.instance }),
...
export var BUFFERED_LIST_PROVIDERS: any[] = [
    AsyncSubscriber,
    RtListService,
    provide(PagedPager, { useValue: RtNullObjectInjectable.instance }),
    provide(RegularPager, { useValue: RtNullObjectInjectable.instance }),
