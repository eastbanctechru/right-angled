...
import { RtListService, RtNullObjectInjectable, RtPagedPager, RtBufferedPager, RtRegularPager } from '../../providers/index';
...
export class DisplayPagerComponent extends ListStateComponent implements DoCheck {
    ...
    constructor( @SkipSelf() pagedPager: RtPagedPager, @SkipSelf() bufferedPager: RtBufferedPager, @SkipSelf() regularPager: RtRegularPager, @SkipSelf() protected listService: RtListService, differs: KeyValueDiffers) {
