...
export var SHARED_DIRECTIVES: any[] = [BufferedFooterComponent, RegularFooterComponent, PagedFooterComponent, SortableHeaderComponent, ToolbarComponent, FilterAreaComponent, CountryDetailsComponent];
